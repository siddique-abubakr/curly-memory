...
class GitHubUser(BaseModel):
    ...
    email: Optional[str] = Field(default=None, description="Public email address")
    hireable: Optional[bool] = Field(default=None, description="Available for hire")
    ...
    public_repos: Optional[int] = Field(
        default=None, description="Number of public repos"
    )
    ...
    following: Optional[int] = Field(
        default=None, description="Number of users following"
    )
...
class GitHubMilestone(BaseModel):
    ...
    description: Optional[str] = Field(
        default=None, description="Milestone description"
    )
    ...
    due_on: Optional[datetime] = Field(default=None, description="Milestone due date")
...
class GitHubBranch(BaseModel):
    ...
    user: Optional[GitHubUser] = Field(default=None, description="Branch owner")
