...
class ReleaseAsset(BaseModel):
    ...
    label: Optional[str] = Field(default=None, description="Asset label/description")
...
class Release(BaseModel):
    ...
    tarball_url: Optional[HttpUrl] = Field(
        default=None, description="Tarball download URL"
    )
    zipball_url: Optional[HttpUrl] = Field(
    ...
    body: Optional[str] = Field(default=None, description="Release description/notes")
    ...
    reactions: Optional[ReleaseReactions] = Field(
